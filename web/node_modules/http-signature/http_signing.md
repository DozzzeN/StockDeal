...
The authorization header and signature would be generated as:
    ...
    Authorization: Signature keyId="rsa-key-1",algorithm="rsa-sha256",signature="Base64(RSA-utils.SHA256(signing string))"
...
The authorization header and signature would be generated as:
    ...
    Authorization: Signature keyId="rsa-key-1",algorithm="rsa-sha256",headers="(request-target) date content-type digest",signature="Base64(RSA-utils.SHA256(signing string))"
...
readability):
    ...
    content-type: application/json + "\n"
    digest: SHA-256=Base64(utils.SHA256(Body))
